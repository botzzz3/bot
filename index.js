...
const config = {
    A187: '📍BOT📍',
    instagram: 'OFF',
    nomer: 'wa.me/+1 (724) 639-6515',
    aktif: '7 jan',
    youtube: '',
    whatsapp: 'https://chat.whatsapp.com/Kye8oXHQLPaHNOFDqdLRUl',
       ...
       case 'lirik':
           lirik(value)
               .then(data => {
                   ...
                   deixe result = `` 📍Letra da música📍 * $ {valor} * \ n \ n \ n $ {lyrics} `
                   client.sendMessage(id, hasil, MessageType.text)
               })
               .catch(err => {
                   console.log(err)
       ...
       case 'igstalk':
           igStalk(value)
               .then(data => {
                   ...
                   let result = `` ✨Bio do Instagram _ $ {value} _ \ n \ n    * Nome do usuário *: $ {Username} _ \ n 🌀 * Nome *: _ $ {Name} _ \ n 🌟 * Número de Seguidores *: _ $ {Total_Followers} _ \ n 🌠 * Total_Following *: _ $ {Total_Following} _ \ n ⭄1 71 ￄ 1 77 * Total_Post *: _ $ {Total_Post} _ `
                   client.sendMessage(id, hasil, MessageType.text)
               })
               .catch(err => {
